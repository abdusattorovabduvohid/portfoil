...
export default function Skills() {
  return (
    <section id="skills" className="bg-black text-white py-24 min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div 
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl font-bold border-l-4 border-[#ff6b00] pl-4 mb-8">Ta'lim</h3>
            ...
            <div className="flex items-center gap-5 bg-[#111] p-6 rounded-3xl border border-gray-800 hover:border-[#ff6b00]/30 transition-all group">
              ...
              <div>
                <h4 className="text-xl font-bold">TDTU</h4>
                <p className="text-gray-500 text-sm">Toshkent Davlat Texnika Universiteti</p>
            ...
            <div className="flex items-center gap-5 bg-[#111] p-6 rounded-3xl border border-gray-800 hover:border-[#ff6b00]/30 transition-all group">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Zamonaviy kasblar markazi</p>
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, x: 0 }}
          >
            <h3 className="text-2xl font-bold border-l-4 border-[#ff6b00] pl-4 mb-8">Texnologiyalar</h3>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {skillList.map((skill, i) => (
                ...
                >
                  <div className={`text-4xl mb-3 ${skill.color} group-hover:drop-shadow-[0_0_10px_rgba(255,107,0,0.3)] transition-all`}>
                    {skill.icon}
                  </div>
