...
const navLinks = [
  ...
  { name: "Образование", href: "#skills" },
  { name: "Портфолио", href: "#portfolio" },
  { name: "Контакты", href: "#contact" },
  { name: "CV", href: "/abdusattorovabduvohid.pdf" }, // PDF fayl manzili
  
];
// Komponent ichida render qilish namunasi:
            ...
            >
              <div className="flex flex-col gap-8 text-xl font-semibold">
                {navLinks.map((link) => (
                  ...
                  >
                    {link.name}
                    <span className="opacity-0 group-hover:opacity-100 transition-opacity text-[#ff6b00]">
                      →
                    </span>
                  </a>
                ))}
