...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative min-h-screen bg-black py-[100px] text-white flex items-center overflow-hidden"
    >
      {/* Nuqtalar foni */}
      {init && (
        <Particles
      ...
      <div className="relative justify-center max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full z-20 pt-16">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <motion.h1
            ...
            className="text-[60px] md:text-[100px] font-black leading-none text-[#ff6b00] tracking-tighter"
          >
            Front-End
          </motion.h1>
          <motion.h2
            initial={{ x: 50, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            className="text-[60px] md:text-[100px] font-black leading-none text-white tracking-tighter mb-8"
          >
            developer
          </motion.h2>
          ...
          <div className="flex gap-4">
            {[
              ...
              {
                Icon: FaLinkedinIn,
                url: "https://www.linkedin.com/in/abduvakhid-abdusattorov-b176623bb/",
              },
        ...
        <div className="relative flex items-center justify-center h-[500px] w-full">
          <div className="text-9xl mb-10 font-bold text-[#ff2b28]/40 select-none">
            &lt;/&gt;
          </div>
