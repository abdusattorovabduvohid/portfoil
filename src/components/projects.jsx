...
const projectData = {
  ...
  "Chefina": { // Agar rasm nomi "plant project.png" bo'lsa, bu yerda ham probel bo'lishi kerak
    title: "Chefina",
    link: "https://chefina-uz2.vercel.app/"
  },
  "HouseShop": {
    title: "HouseShop",
    link: "https://build-kappa-liart.vercel.app/"
  },

  "Segway": {
    title: "Segway",
    link: "https://segway-ten.vercel.app/"
  },
  "Foodzy": {
    title: "Foodzy",
    link: "https://foodzy-six.vercel.app/"
  }
};
...
const projects = Object.keys(images).map((path, index) => {
  ...
  return {
    id: index,
    title: data ? data.title : (fileName.charAt(0).toUpperCase() + fileName.slice(1)), 
            ...
            >
              ...
              <div className="p-6 pt-0 flex items-center justify-between">
                ...
                <div className="w-12 h-12 flex items-center justify-center rounded-full bg-black border border-gray-800 group-hover:bg-[#ff6b00] group-hover:border-[#ff6b00] transition-all duration-300">
                  <FaArrowRight className={`text-[#ff6b00] group-hover:text-white transition-all ${!project.isLinked && 'opacity-20'}`} />
                </div>
              </div>
            </motion.a>
          ))}
